...
const fixture = (name: string) =>
  readFileSync(resolve(process.cwd(), 'src/modules/books/external/epubbooks/__fixtures__', name), 'utf8');
...
test('parseEpubBooksCatalogPageHtml extracts /book/<id>-<slug> links', () => {
  ...
  assert.deepEqual(slugs.sort(), ['2263-five-fall-into-adventure', '44-pride-and-prejudice', '608-the-great-gatsby'].sort());
});
