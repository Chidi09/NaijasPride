...
test('pickPreferredElsciFile prioritizes requested format first', () => {
  const epub: ElsciLightNovelFile = {
    ...
    absoluteUrl: 'https://server.elsci.one/Officially%20Translated%20Light%20Novels/Book/Book%20Vol%2001.epub',
    title: 'Book Vol 01',
    series: 'Book',
  ...
  const pdf: ElsciLightNovelFile = {
    ...
    absoluteUrl: 'https://server.elsci.one/Officially%20Translated%20Light%20Novels/Book/Book%20Vol%2001.pdf',
