...
import { computeAnimepaheReleasePage, extractAnimepaheM3u8FromHtml } from './animepahe-resolver';
...
test('extractAnimepaheM3u8FromHtml returns direct m3u8 when present', () => {
  const html = '<html><body><script>var u="https://kisa-01.example.org/hls/a/b/c/owo.m3u8";</script></body></html>';
