  ...
  template: `
    <div class="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <div class="container mx-auto px-4 py-12">
        ...
        <div class="mt-6 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg p-6 md:p-8">
          <p class="text-[var(--text-secondary)] leading-relaxed whitespace-pre-line">{{ body }}</p>
        </div>
      </div>
    </div>
  `,
