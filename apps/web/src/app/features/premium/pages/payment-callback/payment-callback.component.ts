      ...
      <div class="max-w-md w-full text-center space-y-6">
        ...
        @if (status === 'failed') {
          ...
          <div class="flex gap-4 justify-center">
            ...
            <a routerLink="/movies" class="inline-block border border-cinema-500/60 text-cinema-500 font-bold px-6 py-3 rounded-full hover:bg-cinema-500/10 transition-colors">
              Go to Browse
            </a>
          </div>
        }
