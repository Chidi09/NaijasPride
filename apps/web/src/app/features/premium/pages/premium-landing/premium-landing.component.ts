...
@Component({
  ...
  template: `
    <div class="min-h-screen relative flex items-center justify-center bg-cinema-900 overflow-hidden">
      ...
      <div class="absolute inset-0 bg-vignette pointer-events-none"></div>

      <div class="relative z-10 max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 p-8">
        
        <div class="flex flex-col justify-center space-y-6">
          <h1 class="text-5xl md:text-6xl font-serif text-white leading-tight">
            Unlock the <br>
          ...
          <div class="flex gap-8 text-sm text-cinema-100 mt-4">
            <div class="flex flex-col">
              <span class="font-bold text-2xl">4K</span>
              <span class="text-gray-500 text-xs uppercase tracking-widest">Resolution</span>
            </div>
            <div class="flex flex-col">
              <span class="font-bold text-2xl">∞</span>
              <span class="text-gray-500 text-xs uppercase tracking-widest">Downloads</span>
            </div>
            <div class="flex flex-col">
              <span class="font-bold text-2xl">0</span>
              <span class="text-gray-500 text-xs uppercase tracking-widest">Ads</span>
            </div>
          </div>
        </div>

        <div class="bg-cinema-800/50 backdrop-blur-sm border border-white/5 p-8 rounded-sm shadow-2xl">
          <h3 class="font-serif text-2xl text-white mb-6">Select Your Access</h3>
          ...
          <div class="space-y-4">
            ...
            >
              <div>
                ...
                <p class="text-xs text-gray-500">Flexible access, cancel anytime.</p>
              </div>
            ...
            >
              ...
              <div>
                <p class="font-bold text-white group-hover:text-cinema-100">Annual Membership</p>
                <p class="text-xs text-gray-500">12 months of uninterrupted access.</p>
              </div>
