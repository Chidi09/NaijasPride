    ...
    <div class="music-page pb-40">
      ...
      <div class="hero-shell">
        ...
        <div class="hero-content">
          ...
          <p class="hero-sub">
            Afrobeats · Highlife · Afrojuju · and more from Nigeria &amp; Africa
          </p>
            ...
            <section class="glass-section takeover">
              <div class="section-head">
                <span class="section-title">
                  Genre Spotlight&ensp;—&ensp;<span
                    style="color:rgba(220,80,100,0.9)"
                    >{{ featured()!.genreTakeover!.genre }}</span
                  >
                </span>
              </div>
              <div class="carousel">
          ...
          @if (featured()!.replayLoop.length > 0) {
            <section class="glass-section">
              <div class="section-head">
                ...
                <span
                  class="text-xs"
                  style="color:rgba(255,255,255,0.2);font-weight:600;"
                  >Most replayed</span
                >
              </div>
              <div class="carousel">
  ...
  ngOnInit(): void {
    this.musicApi.getFeatured().subscribe({
      next: (res) => {
        ...
        const hero =
          res.data?.trending?.[0] ?? res.data?.newReleases?.[0] ?? null;
