  ...
  template: `
    <div class="min-h-screen bg-gray-950 text-white pb-28">
      ...
      @if (artist()) {
        <!-- Artist header -->
        <header
          class="relative bg-gradient-to-b from-[#800020]/40 to-gray-950 px-4 pt-16 pb-10"
        >
          <div class="max-w-7xl mx-auto">
            <div class="flex items-end gap-6">
              <!-- Avatar placeholder (initials) -->
              <div
                class="w-24 h-24 md:w-32 md:h-32 rounded-full bg-[#800020] flex items-center justify-center flex-shrink-0 shadow-2xl text-3xl font-bold"
              >
                {{ initials() }}
              </div>
              <div>
