        ...
        @if (isVerifying) {
          <div class="mt-8 text-center">
            <div class="mb-4 flex justify-center">
              <app-loading-icon [size]="40" strokeColor="#800020" />
            </div>
            <p class="text-[#7b6660] dark:text-[#d7c4b6]">
          ...
          <div class="mt-8 text-center">
            ...
            <p class="text-[#7b6660] dark:text-[#d7c4b6] mb-6">
              ...
              enjoy all features of NaijasPride.
            </p>
            <a
              [routerLink]="['/movies']"
          ...
          <div class="mt-8 text-center">
            ...
            <div class="space-y-3">
              ...
              <a
                [routerLink]="['/login']"
                class="inline-block text-sm text-[#800020] dark:text-[#d6b87a] hover:underline"
              >
                Back to Login
              </a>
            </div>
