...
@Component({
  ...
  template: `
    <div
      class="relative min-h-screen overflow-hidden bg-[#f7efe8] dark:bg-[#0b0708] flex items-center justify-center px-4"
    >
      <div
      ...
      <div class="relative text-center max-w-lg">
        ...
        <div class="text-[120px] font-bold text-[#800020]/20 leading-none mb-4">
          404
        </div>

        <h1
          class="font-['Cinzel'] text-4xl md:text-5xl font-bold text-[#2a1c1f] dark:text-[#f3e5d8] mb-4"
        >
          Page Not Found
        </h1>
        ...
        <div class="mt-12 pt-8 border-t border-[#d8b7a8] dark:border-[#5f1327]">
          <p class="text-sm text-[#8a756e] dark:text-[#a88a78]">
            ...
            <a
              [routerLink]="['/contact']"
              class="text-[#800020] dark:text-[#d6b87a] hover:underline"
              >Contact Support</a
            >
          </p>
        </div>
