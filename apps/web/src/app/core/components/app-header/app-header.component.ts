    ...
    `
      ...
      .notification-item {
        ...
        border-bottom: 1px solid
          color-mix(in srgb, var(--border-color, #d8c2b8) 65%, transparent);
        transition: background 0.2s ease;
      }
...
export class AppHeaderComponent {
  ...
  notifications = signal([
    {
      id: "n1",
      title: "Fresh movies dropped",
      meta: "New stream and embed titles are now live.",
      link: "/movies",
    },
    {
      id: "n2",
      title: "Your library is ready",
      meta: "Pick up from where you stopped watching.",
      link: "/library",
    },
    {
      id: "n3",
      title: "Discover trending music",
      meta: "New charting tracks have landed.",
      link: "/music",
    },
  ]);
