...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <footer class="bg-[var(--bg-secondary)] text-[var(--text-primary)] border-t border-[var(--border-color)]">
      <div class="max-w-7xl mx-auto px-6 md:px-8 pt-16 pb-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-10 border-b border-[var(--border-color)]">
          ...
          <div class="flex gap-6 md:gap-8 text-[10px] md:text-xs tracking-[0.2em] text-[var(--text-secondary)]">
            <a href="https://youtube.com" target="_blank" rel="noopener" class="hover:text-[var(--text-primary)] transition-colors">YOUTUBE</a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10">
          ...
          <div>
            ...
            <div class="flex flex-col gap-2 text-sm text-[var(--text-secondary)]">
              ...
              <a routerLink="/premium" class="hover:text-[var(--text-primary)] transition-colors">Premium</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="flex flex-col gap-2 text-sm text-[var(--text-secondary)]">
              <a routerLink="/help" class="hover:text-[var(--text-primary)] transition-colors">Help Center</a>
              <a routerLink="/faq" class="hover:text-[var(--text-primary)] transition-colors">FAQ</a>
              <a routerLink="/ways-to-watch" class="hover:text-[var(--text-primary)] transition-colors">Ways to Watch</a>
              <a routerLink="/contact" class="hover:text-[var(--text-primary)] transition-colors">Contact Us</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="flex flex-col gap-2 text-sm text-[var(--text-secondary)]">
              <a routerLink="/terms" class="hover:text-[var(--text-primary)] transition-colors">Terms of Use</a>
              <a routerLink="/privacy" class="hover:text-[var(--text-primary)] transition-colors">Privacy Policy</a>
              <a routerLink="/cookies" class="hover:text-[var(--text-primary)] transition-colors">Cookie Policy</a>
              <a routerLink="/corporate" class="hover:text-[var(--text-primary)] transition-colors">Corporate Info</a>
            </div>
          </div>
        </div>
