    ...
    >
      @if (isDark()) {
        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M12 3v2.5M12 18.5V21M4.93 4.93l1.77 1.77M17.3 17.3l1.77 1.77M3 12h2.5M18.5 12H21M4.93 19.07l1.77-1.77M17.3 6.7l1.77-1.77M16 12a4 4 0 11-8 0 4 4 0 018 0z" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
        </svg>
      } @else {
        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M21 13.09A9 9 0 1110.91 3 7 7 0 0021 13.09z" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      }
    </button>
  `
...
export class ThemeToggleComponent {
  ...
  regularClass = computed(() => this.isDark()
  ...
  compactClass = computed(() => this.isDark()
