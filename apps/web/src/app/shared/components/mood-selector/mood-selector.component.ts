...
export class MoodSelectorComponent {
  ...
  moods: MoodOption[] = [
    ...
    { value: 'chill',     label: 'Chill',     description: 'Relaxing, feel-good vibes' },
    { value: 'intense',   label: 'Intense',   description: 'Action, thriller, drama' },
    { value: 'family',    label: 'Family',    description: 'Safe for everyone' },
    { value: 'nollywood', label: 'Nollywood', description: 'Nigerian cinema only' },
  ];
}
